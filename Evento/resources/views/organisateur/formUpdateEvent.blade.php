            ...
            <form action="{{route('update_event')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="-mx-3 flex flex-wrap">
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input value="{{$event->title}}" type="text" name="title" placeholder="Event title"
                ...
                <div class="-mx-3 flex flex-wrap">
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input value="{{$event->price}}" type="number" name="price" id="date" placeholder="245.00"
                                   class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"/>
                        </div>
                    </div>
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input value="{{$event->nbr_place}}" type="number" name="nbr_place" id="time" placeholder="Nombre de places"
                                   class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <textarea type="text" name="description" placeholder="Event description"
                              class="w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"/>{{$event->description}}
                    </textarea>
                </div>
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="flex items-center">
                            <input type="radio" name="reservation_type" value="manuel" id="radioButton1"
                                   class="h-5 w-5" {{$event->reservation_type == 'manuel' ? 'checked' : ''}} />
                        ...
                        <div class="flex items-center">
                            <input type="radio" name="reservation_type" value="auto" id="radioButton2"
                                   class="h-5 w-5" {{$event->reservation_type == 'auto' ? 'checked' : ''}} />
